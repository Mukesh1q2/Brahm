  ...
  return (
    <div className="min-h-screen bg-[#0d0d0d] text-gray-100">
      ...
      <section className="relative overflow-hidden">
        {React.createElement(require('./_components/quantum/QuantumFieldBackground').default, { className: 'pointer-events-none -z-10 opacity-70' })}
        ...
        <div className="container px-6 py-24">
          <div className="max-w-2xl">
            <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-3 py-1 text-xs text-gray-300">
              <Sparkles size={14} className="text-neon-purple" /> Quantum‑conscious digital experience
            </div>
            <h1 className="text-4xl font-semibold tracking-tight md:text-6xl">
              Quantum‑Conscious Digital Experience
              <span className="block text-lg font-normal text-gray-400 md:text-xl">Where Quantum Physics Meets AI Consciousness</span>
            </h1>
            <p className="mt-6 max-w-xl text-gray-300">
              Explore superposition, entanglement and tunneling with live visualizations. Interact with Brahm’s consciousness—attention, φ, ethics and tools—in an accessible, immersive UI.
            </p>
            <div className="mt-8 flex flex-wrap items-center gap-3">
              ...
              <Link href="/education" className="rounded-lg border border-white/15 bg-white/5 px-4 py-2 text-sm text-gray-200 hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-white/20">
                Education
              </Link>
      ...
      <section className="container px-6 py-12">
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <Feature icon={<Sparkles className="text-gray-300" />} title="Education" desc="Superposition, Tunneling, Gravity demos with voice guidance." href="/education" />
      ...
      <section className="container px-6 pb-8">
        <div className="rounded-xl border border-white/10 bg-white/5 p-6 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            <div className="text-lg font-medium">Quantum Physics Education Hub</div>
            <div className="text-sm text-gray-400">Interactive lessons for Superposition, Entanglement & Tunneling with voice guidance.</div>
          </div>
          <Link className="rounded-md bg-brand-600 px-4 py-2 text-sm hover:bg-brand-500" href="/education">Open Lessons</Link>
        </div>
      </section>
